...
function add_work(a) {
    ...
    for (let j = 0;j < work_list.length;j++){
        if (work_list[j].innerHTML == '프론트엔드'){
            ...
            if (k!=1){
                let langs_mob = document.getElementById('langs_mob')
                langs_mob.innerHTML = '<label class="langs mob_lang m_lang1"><input class="mob_lang m_lang1" id="Flutter" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Flutter">Flutter</label><label class="langs mob_lang m_lang2"><input class="mob_lang m_lang2" id="Swift" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Swift">Swift</label><label class="langs back_lang b_lang6"><input class="back_lang b_lang6" id="Kotlin" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Kotlin">Kotlin</label><label class="langs mob_lang m_lang4"><input class="mob_lang m_lang4" id="ReactNative" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="ReactNative">ReactNative</label><label class="langs mob_lang m_lang5"><input class="mob_lang m_lang5" id="Unity" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Unity">Unity</label>'
            }
        } else if (work_list[j].innerHTML == '기타') {
            let langs_etc = document.getElementById('langs_etc')
            langs_etc.innerHTML = '<label class="langs etc_lang e_lang1"><input class="etc_lang e_lang1" id="AWS" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="AWS">AWS</label><label class="langs etc_lang e_lang2"><input class="etc_lang e_lang2" id="Kubernetes" onclick="add_lang(this)" type="checkbox" value="Kubernetes">Kubernetes</label><label class="langs etc_lang e_lang3"><input class="etc_lang e_lang3" id="Docker" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Docker">Docker</label><label class="langs etc_lang e_lang4"><input class="etc_lang e_lang4" id="Git" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Git">Git</label><label class="langs etc_lang e_lang5"><input class="etc_lang e_lang5" id="Figma" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Figma">Figma</label><label class="langs etc_lang e_lang6"><input class="etc_lang e_lang3" id="Zeplin" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Zeplin">Zeplin</label><label class="langs etc_lang e_lang7"><input class="etc_lang e_lang4" id="Jest" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="Jest">Jest</label><label class="langs etc_lang e_lang8"><input class="etc_lang e_lang5" id="C" onclick="add_lang(this)" type="checkbox" name="slt_lang" value="C">C</label>'
        }
    }
